...
WHERE [ORDER_DATE] BETWEEN '2008-01-01' AND '2009-01-01'
 ...
 --Завдання 2
 SELECT CUST_NUM, MONTH(ORDER_DATE) AS Місяць_замовлення, COUNT(DISTINCT ORDER_NUM) AS Кількість_Унікальних_Замовленнь
 FROM CUSTOMERS
 LEFT OUTER JOIN ORDERS ON CUST_NUM = CUST
 WHERE[ORDER_DATE] BETWEEN '2008-01-01' AND '2009-01-01'
  AND COMPANY LIKE '%CORP%'
  GROUP BY CUST_NUM, MONTH(ORDER_DATE)
  ORDER BY Кількість_Унікальних_Замовленнь DESC;
